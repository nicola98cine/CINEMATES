...
public class InvioAdapter extends RecyclerView.Adapter<InvioAdapter.ViewHolder> {
    ...
    private  Friends2AdapterListener listener;

    //private com.example.myapplicationcinemates1.ui.Friends.FriendsAdapter.FriendsAdapterListener listener;

    // creating a constructor for our variables.

    public InvioAdapter(ArrayList<UtentiModel> friendModelArrayList, Context context, Friends2AdapterListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        int id;
        System.out.println("Invio Adapter onBindViewHolder");
        ...
        if ((model.getUserid()!=null) &&  (!model.getUserid().isEmpty()) &&  (!model.getUserid().equals(HomeActivity.uid))) {
            ...
            System.out.println("model nome="+ model.getnome());
            System.out.println("model cognome="+ model.getcognome());
            System.out.println("model image="+ model.getImmagine());
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view){
                    listener.onFriend2Selected(friendModelArrayList.get(ViewHolder.this.getAdapterPosition()));
                    //listener.onFriendSelected(friendModelArrayList.get(FriendsAdapter.ViewHolder.this.getAdapterPosition()));
    ...
    public interface Friends2AdapterListener {
        void onFriend2Selected(UtentiModel fm);
    }
}
